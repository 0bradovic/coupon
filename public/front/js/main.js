    ...
    $.ajax({
        ...
        success:function(data){
            ...
            data.forEach(element => {
                ...
                elementDiv.innerHTML = "<a href='/offer/"+element.id+"'><div class='search-div-1'> <img src="+element.img_src+"> <div class='articleText'> <p class='article'>"+element.name+"</p></div></div></a>"                    
