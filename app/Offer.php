...
class Offer extends Model
{
    ...
    protected $fillable = [
        ...
        'position', 'user_id','img_src', 'alt_tag', 'endDateNull','slug','click', 'display','full_link','fp_position','top',
    ];
    ...
    public function formatDetails($string)
    {
        ...
        $replace = ". ";  
        $pattern = "/<[^\/>]*>([\s]?)*<\/[^>]*>/"; 
        $newString = str_limit(strip_tags(str_replace($search,$replace,preg_replace($pattern, '',$string))),'140','...');
