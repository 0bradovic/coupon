            ...
            <div class="category_blade_content">
                <div class="category_blade_box">
                    ...
                    <div class="category_blade_box_date">
                        ...
                        <div class="category_blade_box_date_bottom">
                            @if($off->endDate)
                                <p @if($offer->dateFormat($off->endDate) <  Helpers::expireSoon() ) style="color:red;" @endif>ends</p>
                                <p @if($offer->dateFormat($off->endDate) <  Helpers::expireSoon() ) style="color:red;" @endif>{{ $off->frontDateFormat( $off->endDate ) }}</p>
                            @else
                                <p>Ongoing</p>
                            @endif
                        </div>
