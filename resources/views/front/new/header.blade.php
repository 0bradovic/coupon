        ...
        <div class="container">
            <div class="header_top">
                <div class="header_top_left">
                    ...
                    <img class="logo" src="./logo.jpg" alt="BeforeTheShop">
                    <p>Every UK coupon, voucher, code & offer right here
                    </p>
                </div>
            ...
            <div class="header_bottom">
                <ol class="navigation">
                    <li><a href="#" class="navigation_item">Supermarket</a>
        ...
        <div class="mobile_menu_content">
            ...
            <div class="dropdown_item">
                <div class="dropdown_item_click">
                    <a href="#">Supermarket</a> <i class="fa fa-caret-down open_dropdown" aria-hidden="true"></i>
                </div>
