    ...
    <article>
        ...
        @foreach($categories as $key=>$value)
            <div class="dropdown">
                ...
                <button class="dropbtn">{{ $key }}<span class="spanrr">{{end($value)}}</span><i class="fas fa-chevron-down"
        ...
        <section id="box">
            ...
            <div class="container-fluid">
                <div class="row glavni">
                    ...
                    <div class="col-auto col-12 col-md-12 col-sm-12 col-lg-2 col-xl-2 boxx">
                        <a href="prva.html" class="btn-see">@if(count($cat->offers) > 3)See {{ count($cat->offers)-3 }} more...@else No more offers... @endif</a>
                    </div>
                </div>
            </div>
                @endif
